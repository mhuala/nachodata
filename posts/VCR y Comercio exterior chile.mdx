...
[INDICE VCRE](https://www.researchgate.net/publication/272167573_Indice_de_ventaja_comparativa_revelada_un_indicador_del_desempeno_y_de_la_competitividad_productivo-comercial_de_un_pais)

$ VCRe =  ln\left [ \left ( \frac{X_{ij}}{X_{it}} \right )/\left ( \frac{X_{im}}{X_{tm}} \right ) \right ] $
...
El contenido de este documento busca calcular el RCA de los prodcutos exportados por la **\*\*\*\***\_\_**\*\*\*\***:**\_:\_\_\_** por lo que la formula queda de la siguiente forma.

$ VCRe =  ln\left [ \left ( \frac{X_{ij}}{X_{it}} \right )/\left ( \frac{X_{ip}}{X_{tp}} \right ) \right ] $
...
```shell
https://www.aduana.cl/exportacion-por-codigo-arancelario/aduana/2018-12-14/095532.htmlhttps://www.aduana.cl/exportacion-por-codigo-arancelario/aduana/2018-12-14/095532.html
```
...
def calculate_RCAe(df_chile,df_region,region_suffix):
    ...
    for index, value in df_merged.iterrows():
        total_exp_prod_region = value[f"FOB_US_IVV_{region_suffix}"]
