const Contact = () => {
    return (
        <div className="min-h-screen flex mx-auto items-center justify-center w-full">
	...
	<form novalidate="" className="space-y-6 ng-untouched ng-pristine ng-valid">
		<div>
			...
			<input id="name" type="text" placeholder="" className="w-full p-3 rounded dark:bg-gray-600" />
		</div>
		<div>
			<label for="email" className="text-sm">Email</label>
			<input id="email" type="email" className="w-full p-3 rounded dark:bg-gray-600" />
		</div>
		<div>
