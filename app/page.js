    ...
    <main className="mt-16 lg:mt-36 px-2">
      ...
      <div className="flex flex-col lg:grid lg:grid-cols-2 xl:items-center h-full justify-center">
        ...
        <div className='flex lg:hidden lg:col-span-1 h-3/4 items-center mt-6 mx-auto'>
          <Image width="0" height="0" className="w-[250px] sm:w-96 lg:w-[600px]" src={avatar} alt="avatar" />
        </div>
        {/* INFO */}
    ...
    <ul className="dynamic-txts">
      ...
      <li><span>Programador</span></li>
        ...
        <div className='hidden lg:grid col-span-1 h-3/4 items-center mt-6 mx-auto'>
          <Image width="0" height="0" className="w-96 lg:w-[600px]" src={avatar} alt="avatar" />
        </div>
      </div>
    {/* TECH STACKS */}
