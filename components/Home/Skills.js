const Skills = () => {
    return (
        ...
        <div className="max-w-6xl mx-auto px-5 py-24 ">
            ...
            <h1 className=" title-font  mb-4 text-4xl font-extrabold leading-10 tracking-tight sm:text-5xl sm:leading-none md:text-6xl">Competencias</h1>
            <p className="text-base xl:w-2/4 lg:w-3/4 mx-auto px-16 md:px-10">Pese al continuo avance de la informática, me preparo día a día para estar a la altura de las necesidades de mis clientes y brindar ayudar a personas que se adentran a este campo.</p>
            <div className="flex my-6 justify-center">
              <div className="w-1/2 h-1 rounded-full bg-indigo-500 inline-flex"></div>
            </div>
          </div>
